...
(function () {
  ...
  function dashboard(view) {
    ...
    view.innerHTML =
      ...
      (window.FLSound ? (() => { const s2 = window.FLSound.summary(); return zoneCard('#/sound', '🗣️', window.FLSound.SECTION, 'Американські звуки: flap T, злиття слів, наголос, слова-пастки, а також числа, дати, час і гроші вголос — ' + s2.items + ' позицій з озвученням.', 0, s2.topics + ' тем'); })() : '') +
